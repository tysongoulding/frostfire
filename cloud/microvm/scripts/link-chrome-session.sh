#!/usr/bin/env bash
# Link session SQLite databases (Cookies, Login Data) across multi-display Chrome profiles.
# Implements "One microVM, one authenticated session" across all 3 agent screens.
