...
SKILL.md is the same format Cursor uses: YAML frontmatter followed by the markdown recipe body.
  ...
  1. ...
  2. ...
A SKILL.md may carry other frontmatter Cursor understands and Grok Bot does not (globs, alwaysApply, environments, metadata). Leave those keys alone: update_state preserves them, and hand-editing the file to drop them breaks the skill for whoever shares it.
