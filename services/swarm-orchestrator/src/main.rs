...
use frostfire_orchestrator::{BlackboardStore, PersonaBlueprint, SprintWorkflow};

#[derive(Parser, Debug)]
#[command(name = "frostfire-orchestrator")]
#[command(about = "Frostfire Swarm Orchestrator: Multi-agent durable workflow engine and Blackboard store")]
struct Args {
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    info!("🚀 Frostfire Swarm Orchestrator Engine Initialized");
