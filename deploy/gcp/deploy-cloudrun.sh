#!/usr/bin/env bash
# ==============================================================================
# Deploy Frostfire Gateway to Google Cloud Run (Serverless gRPC with HTTP/2)
# ==============================================================================
set -euo pipefail

PROJECT_ID="${1:-$(gcloud config get-value project)}"
REGION="${2:-us-central1}"
SERVICE_NAME="frostfire-gateway"
IMAGE_NAME="gcr.io/${PROJECT_ID}/${SERVICE_NAME}:latest"

echo "=========================================================="
echo "🚀 Deploying Frostfire Gateway to Google Cloud Run"
...
echo "=========================================================="
echo "✅ Frostfire Gateway Deployed on Cloud Run Successfully!"
echo "   gRPC Endpoint : ${ENDPOINT}"
echo "   Update local .frostfire.toml server_url to this endpoint"
echo "=========================================================="
